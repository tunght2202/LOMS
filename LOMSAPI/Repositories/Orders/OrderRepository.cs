...
//        public async Task<IEnumerable<OrderModel>> GetOrdersByStatusByLivestreamId(string livestreamId, OrderStatus status)
//        {
//            var getOrder = await GetOrderByLivestreamId(livestreamId);
//            var orders = getOrder.Where(x => x.Status.Equals(status.ToString())).ToList();
//            if (orders.Any())
//            {
//                return orders;
//            }
...
//        public async Task<IEnumerable<OrderModel>> GetOrdersByStatusByUserId(string userId, OrderStatus status)
//        {
