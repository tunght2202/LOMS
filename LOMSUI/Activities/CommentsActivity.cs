...
namespace LOMSUI.Activities
{
    ...
    public class CommentsActivity : Activity
    {
        ...
        private TextView txtNoComments; // Thêm TextView hiển thị thông báo khi không có bình luận
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            txtNoComments = FindViewById<TextView>(Resource.Id.txtNoComments); // Ánh xạ TextView
